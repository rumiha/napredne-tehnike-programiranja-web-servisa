...
# Pokretanje sesije za pohranu podataka o pregledanim vijestima
session_start();
...
print '
	<h1>NEWS</h1>
	<div class="news">';
# Provjera je li varijabla $action postavljena, ako nije prikazuju se sve vijesti
if (!isset($action)) {
    print '
    ...
    # Ako je $action postavljen, prikazuje se pojedinačna vijest
    if ($action == 1) {
        # Postavljanje naslova vijesti u sesiju
        $_SESSION['news_title_1'] = "US growth faster than expected";
        # Prikaz detalja prve vijesti
        print '
        ...
        # Postavljanje naslova treće vijesti u sesiju
        $_SESSION['news_title_3'] = "Hotel booking sites probed by consumer watchdog";
        # Prikaz detalja treće vijesti
        print '
