...
('diagnostics.allow_i_s_tables','OFF','2024-11-23 12:58:20',NULL),
('diagnostics.include_raw','OFF','2024-11-23 12:58:20',NULL),
('ps_thread_trx_info.max_length','65535','2024-11-23 12:58:20',NULL),
('statement_performance_analyzer.limit','100','2024-11-23 12:58:20',NULL),
('statement_performance_analyzer.view',NULL,'2024-11-23 12:58:20',NULL),
('statement_truncate_len','64','2024-11-23 12:58:20',NULL);
...
(1,'Marko','Marković','marko@example.com','markom','hashedpassword',1),
(2,'Ivana','Ivić','ivana@example.com','ivana123','hashedpassword',1),
(3,'Petar','Petrović','petar@example.com','petarp','hashedpassword',2),
(4,'Ana','Anić','ana@example.com','ana123','hashedpassword',2);
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `extract_schema_from_file_name`(
        path VARCHAR(512)
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `extract_table_from_file_name`(
        path VARCHAR(512)
    ) RETURNS varchar(64) CHARSET utf8mb4
    NO SQL
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `format_bytes`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `format_path`(
        in_path VARCHAR(512)
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `format_statement`(
        statement LONGTEXT
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `format_time`(
-- We feed in and return TEXT here, as aggregates of
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `list_add`(
        in_list TEXT,
        in_add_value TEXT
    ) RETURNS text CHARSET utf8mb4
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `list_drop`(
        in_list TEXT,
        in_drop_value TEXT
    ) RETURNS text CHARSET utf8mb4
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_is_account_enabled`(
        in_host VARCHAR(255), 
        in_user VARCHAR(32)
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_is_consumer_enabled`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_is_instrument_default_enabled`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_is_instrument_default_timed`(
        in_instrument VARCHAR(128)
    ) RETURNS enum('YES','NO') CHARSET utf8mb4
    READS SQL DATA
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_is_thread_instrumented`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_thread_id`(
        in_connection_id BIGINT UNSIGNED
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_thread_account`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_thread_stack`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `ps_thread_trx_info`(
        in_thread_id BIGINT UNSIGNED
    ) RETURNS longtext CHARSET utf8mb4
    READS SQL DATA
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `quote_identifier`(in_identifier TEXT) RETURNS text CHARSET utf8mb4
    NO SQL
    DETERMINISTIC
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `sys_get_config`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `version_major`() RETURNS tinyint unsigned
    NO SQL
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `version_minor`() RETURNS tinyint unsigned
    NO SQL
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` FUNCTION `version_patch`() RETURNS tinyint unsigned
    NO SQL
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `create_synonym_db`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `execute_prepared_stmt`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `diagnostics`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_trace_statement_digest`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_trace_thread`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_disable_consumer`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_disable_instrument`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_disable_thread`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_enable_consumer`(
        IN consumer VARCHAR(128)
    )
    MODIFIES SQL DATA
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_enable_instrument`(
        IN in_pattern VARCHAR(128)
    )
    MODIFIES SQL DATA
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_enable_thread`(
        IN in_connection_id BIGINT
    )
    MODIFIES SQL DATA
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_reset_to_default`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_save`(
        IN in_timeout INT
    )
    MODIFIES SQL DATA
    SQL SECURITY INVOKER
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_show_disabled`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_setup_show_enabled`(
        IN in_show_instruments BOOLEAN,
        IN in_show_threads BOOLEAN
    )
    READS SQL DATA
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `ps_truncate_all_tables`(
        IN in_verbose BOOLEAN
    )
    MODIFIES SQL DATA
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `statement_performance_analyzer`(
...
/*!50003 CREATE DEFINER=`mysql.sys`@`localhost` PROCEDURE `table_exists`(
...
/*!50001 CREATE TABLE  `innodb_buffer_stats_by_schema`(
 `object_schema` text ,
 `allocated` varchar(11) ,
 `data` varchar(11) ,
 `pages` bigint ,
 `pages_hashed` bigint ,
 `pages_old` bigint ,
 `rows_cached` decimal(45,0) 
)*/;
...
/*!50001 CREATE TABLE  `io_by_thread_by_latency`(
 `user` varchar(288) ,
 `total` decimal(42,0) ,
 `total_latency` varchar(11) ,
 `min_latency` varchar(11) ,
 `avg_latency` varchar(11) ,
 `max_latency` varchar(11) ,
 `thread_id` bigint unsigned ,
...
/*!50001 CREATE TABLE  `io_global_by_file_by_bytes`(
 ...
 `total_read` varchar(11) ,
 `avg_read` varchar(11) ,
 `count_write` bigint unsigned ,
 `total_written` varchar(11) ,
 `avg_write` varchar(11) ,
 `total` varchar(11) ,
...
/*!50001 CREATE TABLE  `io_global_by_file_by_latency`(
 ...
 `total_latency` varchar(11) ,
 `count_read` bigint unsigned ,
 `read_latency` varchar(11) ,
 `count_write` bigint unsigned ,
 `write_latency` varchar(11) ,
 `count_misc` bigint unsigned ,
 `misc_latency` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `x$io_global_by_file_by_latency`(
 `file` varchar(512) ,
 `total` bigint unsigned ,
 `total_latency` bigint unsigned ,
 `count_read` bigint unsigned ,
 `read_latency` bigint unsigned ,
 `count_write` bigint unsigned ,
 `write_latency` bigint unsigned ,
 `count_misc` bigint unsigned ,
 `misc_latency` bigint unsigned 
)*/;
...
/*!50001 CREATE TABLE  `io_global_by_wait_by_bytes`(
 ...
 `count_write` bigint unsigned ,
 `total_written` varchar(11) ,
 `avg_written` varchar(11) ,
 `total_requested` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `innodb_lock_waits`(
 ...
 `waiting_trx_rows_locked` bigint unsigned ,
 `waiting_trx_rows_modified` bigint unsigned ,
 ...
 `blocking_trx_rows_locked` bigint unsigned ,
 `blocking_trx_rows_modified` bigint unsigned ,
 `sql_kill_blocking_query` varchar(33) ,
 `sql_kill_blocking_connection` varchar(27) 
)*/;
...
/*!50001 CREATE TABLE  `memory_by_user_by_current_bytes`(
 ...
 `current_allocated` varchar(11) ,
 `current_avg_alloc` varchar(11) ,
 `current_max_alloc` varchar(11) ,
 `total_allocated` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `memory_global_by_current_bytes`(
 ...
 `current_alloc` varchar(11) ,
 `current_avg_alloc` varchar(11) ,
 `high_count` bigint ,
 `high_alloc` varchar(11) ,
 `high_avg_alloc` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `schema_index_statistics`(
 ...
 `table_name` varchar(64) ,
 `index_name` varchar(64) ,
 `rows_selected` bigint unsigned ,
 `select_latency` varchar(11) ,
 `rows_inserted` bigint unsigned ,
 `insert_latency` varchar(11) ,
 `rows_updated` bigint unsigned ,
 `update_latency` varchar(11) ,
 `rows_deleted` bigint unsigned ,
 `delete_latency` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `x$schema_index_statistics`(
 ...
 `index_name` varchar(64) ,
 `rows_selected` bigint unsigned ,
 `select_latency` bigint unsigned ,
 `rows_inserted` bigint unsigned ,
 `insert_latency` bigint unsigned ,
 `rows_updated` bigint unsigned ,
 `update_latency` bigint unsigned ,
 `rows_deleted` bigint unsigned ,
 `delete_latency` bigint unsigned 
)*/;
...
/*!50001 CREATE TABLE  `schema_table_statistics`(
 ...
 `table_name` varchar(64) ,
 `total_latency` varchar(11) ,
 `rows_fetched` bigint unsigned ,
 `fetch_latency` varchar(11) ,
 `rows_inserted` bigint unsigned ,
 `insert_latency` varchar(11) ,
 `rows_updated` bigint unsigned ,
 `update_latency` varchar(11) ,
 ...
 `io_read` varchar(11) ,
 `io_read_latency` varchar(11) ,
 `io_write_requests` decimal(42,0) ,
 `io_write` varchar(11) ,
 `io_write_latency` varchar(11) ,
 `io_misc_requests` decimal(42,0) ,
 `io_misc_latency` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `schema_table_statistics_with_buffer`(
 ...
 `io_misc_requests` decimal(42,0) ,
 `io_misc_latency` varchar(11) ,
 `innodb_buffer_allocated` varchar(11) ,
 `innodb_buffer_data` varchar(11) ,
 `innodb_buffer_free` varchar(11) ,
 `innodb_buffer_pages` bigint ,
 `innodb_buffer_pages_hashed` bigint ,
 `innodb_buffer_pages_old` bigint ,
 `innodb_buffer_rows_cached` decimal(45,0) 
)*/;
...
/*!50001 CREATE TABLE  `x$schema_table_statistics_with_buffer`(
 ...
 `io_misc_requests` decimal(42,0) ,
 `io_misc_latency` decimal(42,0) ,
 `innodb_buffer_allocated` decimal(44,0) ,
 `innodb_buffer_data` decimal(44,0) ,
 `innodb_buffer_free` decimal(45,0) ,
 `innodb_buffer_pages` bigint ,
 `innodb_buffer_pages_hashed` bigint ,
 `innodb_buffer_pages_old` bigint ,
 `innodb_buffer_rows_cached` decimal(45,0) 
...
/*!50001 CREATE TABLE  `schema_tables_with_full_table_scans`(
 ...
 `rows_full_scanned` bigint unsigned ,
 `latency` varchar(11) 
)*/;
...
/*!50001 CREATE TABLE  `schema_table_lock_waits`(
 `object_schema` varchar(64) ,
 `object_name` varchar(64) ,
 `waiting_thread_id` bigint unsigned ,
 `waiting_pid` bigint unsigned ,
...
/*!50001 CREATE TABLE  `statement_analysis`(
 ...
 `err_count` bigint unsigned ,
 `warn_count` bigint unsigned ,
 `total_latency` varchar(11) ,
 `max_latency` varchar(11) ,
 `avg_latency` varchar(11) ,
 `lock_latency` varchar(11) ,
 `cpu_latency` varchar(11) ,
 `rows_sent` bigint unsigned ,
 ...
 `rows_sorted` bigint unsigned ,
 `sort_merge_passes` bigint unsigned ,
 `max_controlled_memory` varchar(11) ,
 `max_total_memory` varchar(11) ,
 `digest` varchar(64) ,
...
/*!50001 CREATE TABLE  `x$statement_analysis`(
 ...
 `full_scan` varchar(1) ,
 `exec_count` bigint unsigned ,
 `exec_secondary_count` bigint unsigned ,
 `err_count` bigint unsigned ,
 `warn_count` bigint unsigned ,
 `total_latency` bigint unsigned ,
 `max_latency` bigint unsigned ,
 ...
 `rows_sorted` bigint unsigned ,
 `sort_merge_passes` bigint unsigned ,
 `max_controlled_memory` bigint unsigned ,
 `max_total_memory` bigint unsigned ,
 `digest` varchar(64) ,
 `first_seen` timestamp(6) ,
 `last_seen` timestamp(6) 
)*/;
...
/*!50001 CREATE TABLE  `statements_with_full_table_scans`(
 ...
 `exec_count` bigint unsigned ,
 `total_latency` varchar(11) ,
 `no_index_used_count` bigint unsigned ,
 `no_good_index_used_count` bigint unsigned ,
...
/*!50001 CREATE TABLE  `statements_with_sorting`(
 ...
 `sorts_using_scans` bigint unsigned ,
 `sort_using_range` bigint unsigned ,
 `rows_sorted` bigint unsigned ,
...
/*!50001 CREATE TABLE  `statements_with_temp_tables`(
 ...
 `exec_count` bigint unsigned ,
 `total_latency` varchar(11) ,
 `memory_tmp_tables` bigint unsigned ,
 `disk_tmp_tables` bigint unsigned ,
...
/*!50001 CREATE TABLE  `processlist`(
 ...
 `last_statement_latency` varchar(11) ,
 `current_memory` varchar(11) ,
 `last_wait` varchar(128) ,
 `last_wait_latency` varchar(13) ,
 `source` varchar(64) ,
 `trx_latency` varchar(11) ,
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `version` (`sys_version`,`mysql_version`) AS select '2.1.3' AS `sys_version`,version() AS `mysql_version` */;
...
/*!50001 CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$latest_file_io` (`thread`,`file`,`latency`,`operation`,`requested`) AS select if((`processlist`.`ID` is null),concat(substring_index(`performance_schema`.`threads`.`NAME`,'/',-(1)),':',`performance_schema`.`events_waits_history_long`.`THREAD_ID`),concat(`processlist`.`USER`,'@',`processlist`.`HOST`,':',`processlist`.`ID`)) AS `thread`,`performance_schema`.`events_waits_history_long`.`OBJECT_NAME` AS `file`,`performance_schema`.`events_waits_history_long`.`TIMER_WAIT` AS `latency`,`performance_schema`.`events_waits_history_long`.`OPERATION` AS `operation`,`performance_schema`.`events_waits_history_long`.`NUMBER_OF_BYTES` AS `requested` from ((`performance_schema`.`events_waits_history_long` join `performance_schema`.`threads` on((`performance_schema`.`events_waits_history_long`.`THREAD_ID` = `performance_schema`.`threads`.`THREAD_ID`))) left join `information_schema`.`PROCESSLIST` `processlist` on((`performance_schema`.`threads`.`PROCESSLIST_ID` = `processlist`.`ID`))) where ((`performance_schema`.`events_waits_history_long`.`OBJECT_NAME` is not null) and (`performance_schema`.`events_waits_history_long`.`EVENT_NAME` like 'wait/io/file/%')) order by `performance_schema`.`events_waits_history_long`.`TIMER_START` */;
...
/*!50001 CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$schema_table_statistics_with_buffer` (`table_schema`,`table_name`,`rows_fetched`,`fetch_latency`,`rows_inserted`,`insert_latency`,`rows_updated`,`update_latency`,`rows_deleted`,`delete_latency`,`io_read_requests`,`io_read`,`io_read_latency`,`io_write_requests`,`io_write`,`io_write_latency`,`io_misc_requests`,`io_misc_latency`,`innodb_buffer_allocated`,`innodb_buffer_data`,`innodb_buffer_free`,`innodb_buffer_pages`,`innodb_buffer_pages_hashed`,`innodb_buffer_pages_old`,`innodb_buffer_rows_cached`) AS select `pst`.`OBJECT_SCHEMA` AS `table_schema`,`pst`.`OBJECT_NAME` AS `table_name`,`pst`.`COUNT_FETCH` AS `rows_fetched`,`pst`.`SUM_TIMER_FETCH` AS `fetch_latency`,`pst`.`COUNT_INSERT` AS `rows_inserted`,`pst`.`SUM_TIMER_INSERT` AS `insert_latency`,`pst`.`COUNT_UPDATE` AS `rows_updated`,`pst`.`SUM_TIMER_UPDATE` AS `update_latency`,`pst`.`COUNT_DELETE` AS `rows_deleted`,`pst`.`SUM_TIMER_DELETE` AS `delete_latency`,`fsbi`.`count_read` AS `io_read_requests`,`fsbi`.`sum_number_of_bytes_read` AS `io_read`,`fsbi`.`sum_timer_read` AS `io_read_latency`,`fsbi`.`count_write` AS `io_write_requests`,`fsbi`.`sum_number_of_bytes_write` AS `io_write`,`fsbi`.`sum_timer_write` AS `io_write_latency`,`fsbi`.`count_misc` AS `io_misc_requests`,`fsbi`.`sum_timer_misc` AS `io_misc_latency`,`ibp`.`allocated` AS `innodb_buffer_allocated`,`ibp`.`data` AS `innodb_buffer_data`,(`ibp`.`allocated` - `ibp`.`data`) AS `innodb_buffer_free`,`ibp`.`pages` AS `innodb_buffer_pages`,`ibp`.`pages_hashed` AS `innodb_buffer_pages_hashed`,`ibp`.`pages_old` AS `innodb_buffer_pages_old`,`ibp`.`rows_cached` AS `innodb_buffer_rows_cached` from ((`performance_schema`.`table_io_waits_summary_by_table` `pst` left join `x$ps_schema_table_statistics_io` `fsbi` on(((`pst`.`OBJECT_SCHEMA` = `fsbi`.`table_schema`) and (`pst`.`OBJECT_NAME` = `fsbi`.`table_name`)))) left join `x$innodb_buffer_stats_by_table` `ibp` on(((`pst`.`OBJECT_SCHEMA` = `ibp`.`object_schema`) and (`pst`.`OBJECT_NAME` = `ibp`.`object_name`)))) order by `pst`.`SUM_TIMER_WAIT` desc */;
...
/*!50001 CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$schema_table_lock_waits` (`object_schema`,`object_name`,`waiting_thread_id`,`waiting_pid`,`waiting_account`,`waiting_lock_type`,`waiting_lock_duration`,`waiting_query`,`waiting_query_secs`,`waiting_query_rows_affected`,`waiting_query_rows_examined`,`blocking_thread_id`,`blocking_pid`,`blocking_account`,`blocking_lock_type`,`blocking_lock_duration`,`sql_kill_blocking_query`,`sql_kill_blocking_connection`) AS select `g`.`OBJECT_SCHEMA` AS `object_schema`,`g`.`OBJECT_NAME` AS `object_name`,`pt`.`THREAD_ID` AS `waiting_thread_id`,`pt`.`PROCESSLIST_ID` AS `waiting_pid`,`sys`.`ps_thread_account`(`p`.`OWNER_THREAD_ID`) AS `waiting_account`,`p`.`LOCK_TYPE` AS `waiting_lock_type`,`p`.`LOCK_DURATION` AS `waiting_lock_duration`,`pt`.`PROCESSLIST_INFO` AS `waiting_query`,`pt`.`PROCESSLIST_TIME` AS `waiting_query_secs`,`ps`.`ROWS_AFFECTED` AS `waiting_query_rows_affected`,`ps`.`ROWS_EXAMINED` AS `waiting_query_rows_examined`,`gt`.`THREAD_ID` AS `blocking_thread_id`,`gt`.`PROCESSLIST_ID` AS `blocking_pid`,`sys`.`ps_thread_account`(`g`.`OWNER_THREAD_ID`) AS `blocking_account`,`g`.`LOCK_TYPE` AS `blocking_lock_type`,`g`.`LOCK_DURATION` AS `blocking_lock_duration`,concat('KILL QUERY ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_query`,concat('KILL ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_connection` from (((((`performance_schema`.`metadata_locks` `g` join `performance_schema`.`metadata_locks` `p` on(((`g`.`OBJECT_TYPE` = `p`.`OBJECT_TYPE`) and (`g`.`OBJECT_SCHEMA` = `p`.`OBJECT_SCHEMA`) and (`g`.`OBJECT_NAME` = `p`.`OBJECT_NAME`) and (`g`.`LOCK_STATUS` = 'GRANTED') and (`p`.`LOCK_STATUS` = 'PENDING')))) join `performance_schema`.`threads` `gt` on((`g`.`OWNER_THREAD_ID` = `gt`.`THREAD_ID`))) join `performance_schema`.`threads` `pt` on((`p`.`OWNER_THREAD_ID` = `pt`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `gs` on((`g`.`OWNER_THREAD_ID` = `gs`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `ps` on((`p`.`OWNER_THREAD_ID` = `ps`.`THREAD_ID`))) where (`g`.`OBJECT_TYPE` = 'TABLE') */;
...
/*!50001 CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$user_summary` (`user`,`statements`,`statement_latency`,`statement_avg_latency`,`table_scans`,`file_ios`,`file_io_latency`,`current_connections`,`total_connections`,`unique_hosts`,`current_memory`,`total_memory_allocated`) AS select if((`performance_schema`.`accounts`.`USER` is null),'background',`performance_schema`.`accounts`.`USER`) AS `user`,sum(`stmt`.`total`) AS `statements`,sum(`stmt`.`total_latency`) AS `statement_latency`,ifnull((sum(`stmt`.`total_latency`) / nullif(sum(`stmt`.`total`),0)),0) AS `statement_avg_latency`,sum(`stmt`.`full_scans`) AS `table_scans`,sum(`io`.`ios`) AS `file_ios`,sum(`io`.`io_latency`) AS `file_io_latency`,sum(`performance_schema`.`accounts`.`CURRENT_CONNECTIONS`) AS `current_connections`,sum(`performance_schema`.`accounts`.`TOTAL_CONNECTIONS`) AS `total_connections`,count(distinct `performance_schema`.`accounts`.`HOST`) AS `unique_hosts`,sum(`mem`.`current_allocated`) AS `current_memory`,sum(`mem`.`total_allocated`) AS `total_memory_allocated` from (((`performance_schema`.`accounts` left join `x$user_summary_by_statement_latency` `stmt` on((if((`performance_schema`.`accounts`.`USER` is null),'background',`performance_schema`.`accounts`.`USER`) = `stmt`.`user`))) left join `x$user_summary_by_file_io` `io` on((if((`performance_schema`.`accounts`.`USER` is null),'background',`performance_schema`.`accounts`.`USER`) = `io`.`user`))) left join `x$memory_by_user_by_current_bytes` `mem` on((if((`performance_schema`.`accounts`.`USER` is null),'background',`performance_schema`.`accounts`.`USER`) = `mem`.`user`))) group by if((`performance_schema`.`accounts`.`USER` is null),'background',`performance_schema`.`accounts`.`USER`) order by sum(`stmt`.`total_latency`) desc */;
...
/*!50001 CREATE ALGORITHM=MERGE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$host_summary_by_statement_type` (`host`,`statement`,`total`,`total_latency`,`max_latency`,`lock_latency`,`cpu_latency`,`rows_sent`,`rows_examined`,`rows_affected`,`full_scans`) AS select if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) AS `host`,substring_index(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`EVENT_NAME`,'/',-(1)) AS `statement`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR` AS `total`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT` AS `total_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT` AS `max_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME` AS `lock_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_CPU_TIME` AS `cpu_latency`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT` AS `rows_sent`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED` AS `rows_examined`,`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED` AS `rows_affected`,(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED` + `performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`) AS `full_scans` from `performance_schema`.`events_statements_summary_by_host_by_event_name` where (`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT` <> 0) order by if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`),`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT` desc */;
...
/*!50001 CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$host_summary_by_statement_latency` (`host`,`total`,`total_latency`,`max_latency`,`lock_latency`,`cpu_latency`,`rows_sent`,`rows_examined`,`rows_affected`,`full_scans`) AS select if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) AS `host`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,max(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME`) AS `lock_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_CPU_TIME`) AS `cpu_latency`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT`) AS `rows_sent`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED`) AS `rows_examined`,sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED`) AS `rows_affected`,(sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED`) + sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`)) AS `full_scans` from `performance_schema`.`events_statements_summary_by_host_by_event_name` group by if((`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST` is null),'background',`performance_schema`.`events_statements_summary_by_host_by_event_name`.`HOST`) order by sum(`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`) desc */;
...
/*!50001 CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `x$wait_classes_global_by_avg_latency` (`event_class`,`total`,`total_latency`,`min_latency`,`avg_latency`,`max_latency`) AS select substring_index(`performance_schema`.`events_waits_summary_global_by_event_name`.`EVENT_NAME`,'/',3) AS `event_class`,sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`COUNT_STAR`) AS `total`,sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`) AS `total_latency`,min(`performance_schema`.`events_waits_summary_global_by_event_name`.`MIN_TIMER_WAIT`) AS `min_latency`,ifnull((sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`) / nullif(sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`COUNT_STAR`),0)),0) AS `avg_latency`,max(`performance_schema`.`events_waits_summary_global_by_event_name`.`MAX_TIMER_WAIT`) AS `max_latency` from `performance_schema`.`events_waits_summary_global_by_event_name` where ((`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT` > 0) and (`performance_schema`.`events_waits_summary_global_by_event_name`.`EVENT_NAME` <> 'idle')) group by `event_class` order by ifnull((sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`) / nullif(sum(`performance_schema`.`events_waits_summary_global_by_event_name`.`COUNT_STAR`),0)),0) desc */;
