<?php
// Početak HTML sadržaja za prikaz vijesti
print '
<h1>NEWS</h1>
<div class="news">';

// Provjera je li varijabla $action postavljena
if (!isset($action)) {
    // Prikazivanje sažetka vijesti s linkovima na cijele članke
    print '
    ...
    // Provjera vrijednosti varijable $action za prikaz cijelog članka
    if ($action == 1) {
        // Postavljanje kolačića za praćenje posjećenih vijesti
        setcookie("news_title_1", "US growth faster than expected", time() + 3600, "/");
        // Prikaz cijelog članka za vijest 1
        print '
        ...
        <p>The growth figures - which are subject to revision in the months ahead - appeared to dispel any fears of an economic slowdown.</p>
        ...
        // Prikaz cijelog članka za vijest 2
        print '
        ...
        // Prikaz cijelog članka za vijest 3
        print '
...
// Zatvaranje div elementa za vijesti
print '
</div>';
?>